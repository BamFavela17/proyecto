...
go
           -- procedimiento insertar Como admin--
            ...
            @Contraseña varchar(80)
			as
			insert into Empleados(Nombre,Apellido,Lada,Telefono,Correo,Sexo,idCargo,ciudad,Fecha_contratado,FechaNacimiento,Usuario,Contraseña)
			values (@Nombre,@Apellido,@Lada,@Telefono,@Correo,@Sexo,@idCargo,@ciudad,@Fecha_contratado,@FechaNacimiento,@Usuario,@Contraseña)
			go
			exec PA_insertarCargo 'Administrador','administra todo', 1200
			go
			exec PA_insertarEmpleados 'ABRAHAM', 'FAVELA','+56','6621731410', 'favela17mx@gmail.com', 'M', 1, 'mexico', '2020-05-04', '2024-03-04','Admin', 'gg123'
			-- procedimiento modificar --
			...
			idCargo=@idCargo,ciudad=@ciudad,Fecha_contratado=@Fecha_contratado,FechaNacimiento=@FechaNacimiento,Usuario=@Usuario,Contraseña=@Contraseña where idE=@id
			go
			-- procedimiento modificar --
			...
			as
			update Empleados set Nombre=@Nombre,Apellido=@Apellido,Lada=@Lada,Telefono=@Telefono,Correo=@Correo,Sexo=@Sexo,
			ciudad=@ciudad,Fecha_contratado=@Fecha_contratado,FechaNacimiento=@FechaNacimiento,Usuario=@Usuario,Contraseña=@Contraseña where idE=@id
			go
			-- procedimiento borrar --
...
exec v_venta
exec v_listadoDetalleVenta
>>>>>>> 726e704b3762e3e1f28d5b211cc008955bc9e72a
exec Ver_Cargos 